...
class PlayerVehicle(Vehicle):
    ...
    def __init__(self, x, y):
        image = pygame.image.load(os.path.join(assets_dir, 'car.png'))
...
for image_filename in image_filenames:
    image = pygame.image.load(assets_dir + image_filename)
    vehicle_images.append(image)
    
# load the crash image
crash = pygame.image.load(os.path.join(assets_dir, 'crash.png'))
